...
public class AdminService {
	...
	public Statistics getStatics() {
		...
		return new Statistics(components,peripherals,phone,moderBoard,processor,hardDisck,graphicCard,keyBoard,mouse,monitors,headPhones,tusers,users,admins,earnings, products, tproduct);
	}
